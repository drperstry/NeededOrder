    ...
    <div class="card">
        <div class="card-header" style="background-color: #26EBC0;">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item"><a class="nav-link active" href="GenerateReportStaff.php" style="background-color: #1eb896;">Staff</a></li>
                <li class="nav-item"><a class="nav-link" href="GenerateReportDriver.php" style="background-color: #26ebc0;color: #003049;">Driver</a></li>
